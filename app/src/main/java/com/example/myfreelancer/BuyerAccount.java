...
public class BuyerAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //btn_buyerA_message = findViewById(R.id.btn_buyerA_message);
       ...
       /* btn_buyerA_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent AccIntentToChat = new Intent (BuyerAccount.this , ChatMessage.class);
                startActivity(AccIntentToChat);
            }
        });*/
        ...
        btn_switchSeller.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentToSeller = new Intent (BuyerAccount.this , SellerAccount.class);
                startActivity(intentToSeller);
            }
        });
        ...
        btn_buyerLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentToBLogout.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
