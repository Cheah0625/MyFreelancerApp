...
public class AdapterServiceItem extends RecyclerView.Adapter<AdapterServiceItem.HolderServiceItemList>implements Filterable {
    ...
    public void onBindViewHolder(@NonNull AdapterServiceItem.HolderServiceItemList holder, int position) {
        ...
        //holder.SerItem_Days.setText(sDeliveryDays + " Delivery Days");
        holder.SerItem_Price.setText("RM " + sPrice);
        ...
        //holder.SerItem_Image.setImageResource(currentItem.getServiceImage());
        //holder.SerItem_Title.setText(currentItem.getTitle());
        //holder.SerItem_Days.setText(currentItem.getDays());
        //holder.SerItem_Price.setText(currentItem.getBudget());
