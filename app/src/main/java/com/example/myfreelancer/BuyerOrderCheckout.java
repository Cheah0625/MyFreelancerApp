...
public class BuyerOrderCheckout extends AppCompatActivity {
    ...
    private String STitle, SImage, SDescription, SPrice, SDelivery, SCategory, UName, SBankName, SAccountNumber, SBeneficiaryName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderSum_bankCompany = findViewById(R.id.orderSum_bankCompany);
    ...
    private void loadServiceDetail() {
        ...
        databaseReference.child(serviceID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                orderSum_serTitle.setText(STitle);
                orderSum_price.setText("RM "+SPrice);
    ...
    private void inputData() {
        ...
        /*if (image_uri == null){
            Toast.makeText(getApplicationContext(),"Payment Slip is required.",Toast.LENGTH_SHORT).show();
            return;
        }*/
