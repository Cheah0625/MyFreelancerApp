...
public class BuyerHome extends AppCompatActivity {
    ...
    private void checkUserStatus(){
        ...
        if(user != null){
            ...
            MainCategoryList.add(new Model_MainCategory("Graphics & Design", "Art & Illustration",R.drawable.graphic));
            MainCategoryList.add(new Model_MainCategory("Writing", "Content Writing & Translation",R.drawable.writing));
            MainCategoryList.add(new Model_MainCategory("Video & Animation", "Animation & Editing",R.drawable.video));
            MainCategoryList.add(new Model_MainCategory("Programming", "Web & Mobile Application",R.drawable.programming));
            MainCategoryList.add(new Model_MainCategory("Data", "Entry & Visualisation",R.drawable.data));
            MainCategoryList.add(new Model_MainCategory("Digital Marketing", "Social Media Advertising",R.drawable.marketing));

            adapterMainCategory = new AdapterMainCategory(this,MainCategoryList);
            recyclerViewMainCategory.setAdapter(adapterMainCategory);


            btn_buyer_message.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent HomeIntentToChat = new Intent(BuyerHome.this, ChatMessage.class);
                    startActivity(HomeIntentToChat);
                }
            });
