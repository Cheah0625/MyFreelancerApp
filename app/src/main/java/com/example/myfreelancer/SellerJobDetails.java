...
public class SellerJobDetails extends AppCompatActivity {
    ...
    private TextView jobTitle, jobCategory, jobPrice, jobDays, jobDesc, job_clientLocation, job_clientEmail, job_clientPhone, job_clientName;
    ...
    private void loadProjectInfo() {
        ...
        databaseReference.child(projectID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String PBudget = "RM "+snapshot.child("PBudget").getValue();
                String PDeliveryDays = ""+snapshot.child("PDeliveryDays").getValue() + " Days";
                ...
                jobTitle.setText(PTitle);
                jobDesc.setText(PDescription);
