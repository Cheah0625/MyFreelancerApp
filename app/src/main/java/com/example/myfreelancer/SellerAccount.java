...
public class SellerAccount extends AppCompatActivity {
    ...
    private Button btn_addService, btn_manageService, btn_switchBuyer, btn_sellerLogout, btn_bankInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_sellerAcc_message = findViewById(R.id.btn_sellerAcc_message);
        ...
        btn_sellerAcc_message.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent SAccIntentToChat = new Intent(SellerAccount.this, ChatMessage.class);
                startActivity(SAccIntentToChat);
            }
        });
        ...
        btn_switchBuyer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentToBuyer = new Intent (SellerAccount.this , BuyerAccount.class);
                startActivity(intentToBuyer);
                finish();
            }
        });
        ...
        btn_sellerLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentToSLogout.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
