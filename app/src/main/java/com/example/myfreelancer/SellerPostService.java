...
public class SellerPostService extends AppCompatActivity {
    ...
    private RadioButton seller_serRadioTech, seller_serRadioGraphic, seller_serRadioWriting, seller_serRadioData, seller_serRadioVideo, seller_serRadioMarketing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seller_serRadioTech = findViewById(R.id.seller_serRadioTech);
        seller_serRadioGraphic = findViewById(R.id.seller_serRadioGraphic);
        seller_serRadioWriting = findViewById(R.id.seller_serRadioWriting);
        seller_serRadioData = findViewById(R.id.seller_serRadioData);
        seller_serRadioVideo = findViewById(R.id.seller_serRadioVideo);
        seller_serRadioMarketing = findViewById(R.id.seller_serRadioMarketing);
    ...
    private void inputService() {
        ...
        if (seller_serRadioGraphic.isChecked()) {
            SCategory = "Graphic & Design";
        } else if (seller_serRadioWriting.isChecked()) {
            SCategory = "Writing & Translation";
        } else if (seller_serRadioVideo.isChecked()) {
            SCategory = "Video & Animation";
        } else if (seller_serRadioMarketing.isChecked()) {
            SCategory = "Digital Marketing";
        } else if (seller_serRadioData.isChecked()) {
            SCategory = "Data";
        } else if (seller_serRadioTech.isChecked()) {
        ...
        if(SDelivery.isEmpty()){
            seller_serviceDays.setError("Delivery Days is required.");
            return;
        }
